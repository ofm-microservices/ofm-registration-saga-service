...
// NewBroker constructs the concrete NATS event broker used by
...
// RunPullConsumer starts a JetStream pull consumer with the configured
// concurrency and adaptive batching rules.
