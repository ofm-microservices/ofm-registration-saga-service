...
// Source: /home/alex/projects/ofm-microservices/ofm-registration-saga-service/internal/presentation/event_broker/type.go
//
// Generated by this command:
//
//	mockgen -source=/home/alex/projects/ofm-microservices/ofm-registration-saga-service/internal/presentation/event_broker/type.go -destination=/home/alex/projects/ofm-microservices/ofm-registration-saga-service/internal/presentation/event_broker/mock_test.go -package=eventbroker
//

// Package eventbroker is a generated GoMock package.
package eventbroker
...
func (m *MockEventBroker) RunPullConsumer(ctx context.Context, cfg config.PullConsumerConfig, handler MessageHandler) error {
	m.ctrl.T.Helper()
...
func (m *MockEventBroker) Subscribe(ctx context.Context, subject string, handler MessageHandler) error {
	m.ctrl.T.Helper()
